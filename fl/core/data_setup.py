...
try:
    ...
    print("Warning: Custom dataset loaders not available")
...
NORMALIZE_DICT = {
    ...
    "healthcare": None,  # Healthcare data is already normalized
    "stock": None,  # Stock data is already normalized
}
...
def load_datasets(
    ...
    if dataset == "healthcare":
        ...
        # Subsample for faster training (optional - remove subsample=None for full dataset)
        ...
        trainset = datasets.ImageFolder(
            data_path + dataset + "/train", transform=transformer
        )
        testset = datasets.ImageFolder(
            data_path + dataset + "/test", transform=transformer
        )
    ...
    if hasattr(trainset, "classes"):
        ...
        print(
            f"The training set is created for the classes : ['No Disease', 'Disease']"
        )
    elif dataset == "creditcard":
        print(f"The training set is created for the classes : ['Legitimate', 'Fraud']")
    elif dataset == "stock":
        print(f"The training set is created for the classes : ['Down', 'Up']")
