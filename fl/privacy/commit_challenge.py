"""
Commit–challenge coordinate sampling (audit/sampling.md, design C).
...
coordinates (fl.core.sampling.detection_probability). Coordinates that are not
...
from fl.core.sampling import new_round_seed, sample_indices, sample_size
from fl.privacy.zkp import admission_quorum, anchor_data, round_report, timer


def _service_errors() -> Tuple[type, ...]:
    from fl.core.elgamal_gnark import ElGamalServiceError
    from fl.core.zkp_gnark import GnarkServiceError
