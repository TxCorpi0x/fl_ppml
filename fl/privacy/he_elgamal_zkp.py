"""
Verifiable additive HE + ZKP mode (audit/binding.md Design B + A, audit/norm.md).
...
update can still be malicious, audit/norm.md); confidentiality against holders
of the shared client key; a trusted setup beyond a single party (audit/setup.md);
...
from fl.core.update_bound import FIT_CONFIG_KEY, bound_from_fit_config, max_update_norm, split_bound
