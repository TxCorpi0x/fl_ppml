...
# The update-norm bound comes from ppflx.core.update_bound (server policy), not from here.
...
def norm_chunk_n() -> int:
    ...
    """
    from ppflx.core.gnark_keys import NORM_CIRCUIT, circuit_size
...
def verify_gnark_proofs_light(
    ...
    aggregates (docs/ZKP.md, section 6.5). Malformed or non-canonical entries count as
