...
from ppflx.privacy.registry import register_mode, get_privacy_mode, list_modes

# Auto-import built-in modes so their @register_mode decorators run.
from ppflx.privacy import (
    baseline,
    he_tenseal,
    he_concrete_tfhe,
    zkp,
    ...
    zkp_sampled,  # zkp_sampled (commit–challenge, benchmark only)
    he_elgamal_zkp_sampled,  # he_elgamal_zkp_sampled (commit–challenge)
)  # noqa: F401
