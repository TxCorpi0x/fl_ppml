...
Includes the Step 5 adversary (a committed coordinate that doesn't match what
the client later proves) and the Step 7 one (a committed coordinate whose
...
is analysed in audit/sampling.md.
"""
